    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anime', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_ratings', to='ananimeclip.anime')),
                ('movie', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_ratings', to='ananimeclip.movie')),
