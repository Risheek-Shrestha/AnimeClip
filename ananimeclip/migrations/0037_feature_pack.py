        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'content_type',
                    models.CharField(
                        choices=[('anime', 'Anime'), ('movie', 'Movie'), ('mixed', 'Mixed')],
                        default='anime',
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'anime',
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ananimeclip.anime'
                    ),
                ),
                (
                    'movie',
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ananimeclip.movie'
                    ),
                ),
                (
                    'row',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='items', to='ananimeclip.curatedrow'
                    ),
                ),
            ],
            options={'ordering': ['order'], 'app_label': 'ananimeclip'},
